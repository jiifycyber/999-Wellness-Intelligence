                          ...
                          : ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return CheckboxListTile(
                                  value: checked,
                                  activeColor: const Color(0xFF25DFFF),
                                  checkColor: const Color(0xFF00111A),
                                  secondary: CircleAvatar(
                                    backgroundColor: const Color(0xFF152D59),
                                    child: Text(
                                      name.isEmpty
                                          ? '?'
                      ...
                      child: SizedBox(
                        ...
                        child: FilledButton(
                          ...
                          style: FilledButton.styleFrom(
                            backgroundColor: const Color(0xFF5B45FF),
          ...
          child: SizedBox(
            ...
            child: Column(
              children: [
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return ListTile(
                        ...
                        trailing: selectedFeelingActivity == value
                            ? const Icon(
                ...
                TextButton(
                  onPressed: () => Navigator.of(sheetContext).pop(''),
                  child: const Text('Remove feeling / activity'),
                ),
