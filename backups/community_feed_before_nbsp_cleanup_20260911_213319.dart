...
import 'community_camera_capture.dart';
...
class CommunityFeedController {
  ...
  VoidCallback? _openStoryCallback;
  VoidCallback? _openReelCallback;
  VoidCallback? _openLiveCallback;
  VoidCallback? _openNoteCallback;

  void openComposer() => _openComposerCallback?.call();
  void openStory() => _openStoryCallback?.call();
  void openReel() => _openReelCallback?.call();
  void openLive() => _openLiveCallback?.call();
  void openNote() => _openNoteCallback?.call();
}
...
class _CommunityFeedScreenState extends State<CommunityFeedScreen> {
  ...
  List<Map<String, dynamic>> storyPosts = [];
  List<Map<String, dynamic>> reelPosts = [];
  ...
  void initState() {
    ...
    widget.controller?._openComposerCallback = _openMobileComposer;
    widget.controller?._openStoryCallback = _openStoryCreator;
    widget.controller?._openReelCallback = _openReelCreator;
    widget.controller?._openLiveCallback = _goLiveSetup;
    widget.controller?._openNoteCallback = _openNoteCreator;
  ...
  void didUpdateWidget(covariant CommunityFeedScreen oldWidget) {
    ...
    if (oldWidget.controller != widget.controller) {
      oldWidget.controller?._openComposerCallback = null;
      oldWidget.controller?._openStoryCallback = null;
      oldWidget.controller?._openReelCallback = null;
      oldWidget.controller?._openLiveCallback = null;
      oldWidget.controller?._openNoteCallback = null;
  ...
  void dispose() {
    ...
    widget.controller?._openLiveCallback = null;
    widget.controller?._openNoteCallback = null;
  ...
  Future<void> _loadFeed() async {
    ...
    try {
      ...
      setState(() {
        ...
        storyPosts = mappedPosts.where((post) {
          if (post['content_type']?.toString() != 'story') {
            return false;
          }

          final rawExpiry = post['expires_at']?.toString() ?? '';
          final expiry = DateTime.tryParse(rawExpiry);

          return expiry == null || expiry.toUtc().isAfter(now);
        }).toList();

        reelPosts = mappedPosts
            .where((post) => post['content_type']?.toString() == 'reel')
            .toList();

        posts = mappedPosts.where((post) {
          final type = post['content_type']?.toString().trim() ?? '';

          return type.isEmpty || type == 'post' || type == 'note';
        }).toList();
  ...
  Future<void> _openStoryViewer(Map<String, dynamic> story) async {
    await Navigator.of(context).push(
      MaterialPageRoute(
        fullscreenDialog: true,
        builder: (_) => _CommunityStoryViewer(story: story),
      ),
    );
  }
  ...
  Widget _storiesAndReelsSection() {
    ...
    Map<String, dynamic>? ownStory;

    for (final story in storyPosts) {
      if (story['author_id']?.toString() == currentUserId) {
        ownStory = story;
        break;
      }
    }
          ...
          SizedBox(
            ...
            child: ListView(
              ...
              children: [
                ...
                if (ownStory != null)
                  InkWell(
                    onTap: () => _openStoryViewer(ownStory!),
                    borderRadius: BorderRadius.circular(18),
                    child: _storyPreviewCard(
                      ...
                      isOwn: true,
                      icon: ownStory['media_type']?.toString() == 'video'
              ...
              children: [
                Row(
                  children: [
                    ...
                    const Expanded(
                      child: Text(
                        'SHORT VIDEOS â€¢ WELLNESS â€¢ COMMUNITY',
                        maxLines: 1,
  ...
  Future<String?> _showMediaSourceSheet({required bool story}) async {
    return showModalBottomSheet<String>(
      context: context,
      useSafeArea: true,
      backgroundColor: Colors.transparent,
      builder: (sheetContext) {
        final accent = story
            ? const Color(0xFFB74DFF)
            : const Color(0xFFFF4DCE);
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            gradient: const LinearGradient(
              ...
              colors: [Color(0xFF0C1730), Color(0xFF11112B), Color(0xFF080D1A)],
            ),
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                story ? 'Create Story' : 'Create Reel',
                style: const TextStyle(
                  color: Colors.white,
                  fontSize: 22,
                  fontWeight: FontWeight.w900,
              ...
              ListTile(
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(18),
                  side: BorderSide(
                    color: const Color(0xFF39E7FF).withValues(alpha: .42),
                  ),
                ),
                tileColor: const Color(0xFF39E7FF).withValues(alpha: .08),
                leading: Icon(
                  story ? Icons.camera_alt_rounded : Icons.videocam_rounded,
                  color: const Color(0xFF39E7FF),
                  size: 30,
                ),
                title: Text(
                  story ? 'Open Camera' : 'Record Reel',
                  style: const TextStyle(
                    color: Colors.white,
                    fontWeight: FontWeight.w900,
                  ),
              ...
              ListTile(
                ...
                tileColor: accent.withValues(alpha: .07),
                leading: Icon(
                ...
                title: Text(
                  story ? 'Upload Photo or Video' : 'Upload Video',
                  style: const TextStyle(
                    color: Colors.white,
                    fontWeight: FontWeight.w900,
                  ),
                ...
                subtitle: const Text(
                  'Choose existing media from your device',
  ...
  Future<String?> _mediaCaption({required bool story}) async {
    ...
    final value = await showDialog<String>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        title: Text(
          story ? 'Finish Your Story' : 'Finish Your Reel',
          style: const TextStyle(
            color: Colors.white,
            fontWeight: FontWeight.w900,
          ),
        ...
        content: TextField(
          ...
          style: const TextStyle(color: Colors.white),
          decoration: InputDecoration(
            hintText: story ? 'Add a Story caption...' : 'Caption your Reel...',
        ...
        actions: [
          ...
          FilledButton(
            ...
            child: Text(story ? 'Share Story' : 'Publish Reel'),
          ),
        ],
      ),
    );
  ...
  String _communityMediaMimeType(String fileName, {required bool isVideo}) {
    ...
    // Chrome camera recordings are normally WebM.
    if (isVideo) return 'video/webm';
  ...
  Future<void> _publishStoryMedia({
    ...
    final caption = await _mediaCaption(story: true);
    ...
    try {
      if (bytes.length > 52428800) {
        throw Exception('Story media must be 50 MB or smaller.');
      }

      final stamp = DateTime.now().microsecondsSinceEpoch;

      mediaPath = '${user.id}/stories/${stamp}_${_safeName(fileName)}';
      ...
      await Supabase.instance.client.storage
          ...
          .uploadBinary(
            ...
            fileOptions: FileOptions(
              upsert: false,
              contentType: _communityMediaMimeType(fileName, isVideo: isVideo),
            ),
          );
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Unable to create Story: $error')));
    }
  }

  Future<void> _publishReelMedia({
    required Uint8List bytes,
    required String fileName,
  }) async {
    final caption = await _mediaCaption(story: false);
    if (caption == null) return;
    ...
    try {
      if (bytes.length > 104857600) {
        throw Exception('Reels must be 100 MB or smaller.');
      }

      final stamp = DateTime.now().microsecondsSinceEpoch;

      mediaPath = '${user.id}/reels/${stamp}_${_safeName(fileName)}';
      ...
      await Supabase.instance.client.storage
          ...
          .uploadBinary(
            ...
            fileOptions: FileOptions(
              upsert: false,
              contentType: _communityMediaMimeType(fileName, isVideo: true),
            ),
          );
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Unable to create Reel: $error')));
    }
  }
  ...
  Future<void> _openStoryCreator() async {
    ...
    final source = await _showMediaSourceSheet(story: true);

    if (source == null || !mounted) return;

    if (source == 'camera') {
      final result = await Navigator.of(context).push<CommunityCameraResult>(
        MaterialPageRoute(
          fullscreenDialog: true,
          builder: (_) => const CommunityCameraCaptureScreen(
            mode: CommunityCameraMode.story,
          ),
        ),
      );
    ...
    final isVideo = const ['mp4', 'mov', 'm4v'].contains(extension);
  ...
  Future<void> _openReelCreator() async {
    FocusScope.of(context).unfocus();

    final source = await _showMediaSourceSheet(story: false);
    ...
    if (source == 'camera') {
      ...
      await _publishReelMedia(bytes: result.bytes, fileName: result.fileName);
    ...
    await _publishReelMedia(bytes: bytes, fileName: file.name);
  }

  Future<void> _openNoteCreator() async {
    FocusScope.of(context).unfocus();
    ...
    try {
      ...
      ScaffoldMessenger.of(
        context,
      ).showSnackBar(SnackBar(content: Text('Unable to share Note: $error')));
    }
  }
...
class _CommunityStoryViewer extends StatefulWidget {
Â Â const _CommunityStoryViewer({
Â Â Â Â required this.stories,
Â Â Â Â required this.initialIndex,
Â Â });

Â Â final List<Map<String, dynamic>> stories;
Â Â final int initialIndex;

Â Â @override
Â Â State<_CommunityStoryViewer> createState() =>
Â Â Â Â Â Â _CommunityStoryViewerState();
}

class _CommunityStoryViewerState extends State<_CommunityStoryViewer> {
Â Â VideoPlayerController? _videoController;

Â Â final TextEditingController _replyController = TextEditingController();

Â Â late int _index;

Â Â bool _videoReady = false;
Â Â bool _muted = false;
Â Â bool _sendingReply = false;
Â Â bool _advancing = false;

Â Â String? _videoError;
Â Â double _progress = 0;

Â Â Map<String, dynamic> get _story => widget.stories[_index];

Â Â bool get _isVideo => _story['media_type']?.toString() == 'video';

Â Â String get _mediaUrl => _story['_media_url']?.toString().trim() ?? '';

Â Â String get _authorId => _story['author_id']?.toString() ?? '';

Â Â bool get _isOwnStory =>
Â Â Â Â Â Â Supabase.instance.client.auth.currentUser?.id == _authorId;

Â Â @override
Â Â void initState() {
Â Â Â Â super.initState();

Â Â Â Â if (widget.initialIndex < 0) {
Â Â Â Â Â Â _index = 0;
Â Â Â Â } else if (widget.initialIndex >= widget.stories.length) {
Â Â Â Â Â Â _index = widget.stories.length - 1;
Â Â Â Â } else {
Â Â Â Â Â Â _index = widget.initialIndex;
Â Â Â Â }

Â Â Â Â _loadCurrentStory();
Â Â }

Â Â Future<void> _loadCurrentStory() async {
Â Â Â Â _advancing = false;

Â Â Â Â final old = _videoController;

Â Â Â Â if (old != null) {
Â Â Â Â Â Â old.removeListener(_videoListener);
Â Â Â Â Â Â await old.dispose();
Â Â Â Â }

Â Â Â Â if (!mounted) return;

Â Â Â Â setState(() {
Â Â Â Â Â Â _videoController = null;
Â Â Â Â Â Â _videoReady = false;
Â Â Â Â Â Â _videoError = null;
Â Â Â Â Â Â _progress = 0;
Â Â Â Â });

Â Â Â Â if (!_isVideo || _mediaUrl.isEmpty) {
Â Â Â Â Â Â Future<void>.delayed(const Duration(seconds: 5), () {
Â Â Â Â Â Â Â Â if (!mounted || _isVideo || _advancing) return;

Â Â Â Â Â Â Â Â _advancing = true;
Â Â Â Â Â Â Â Â _nextStory();
Â Â Â Â Â Â });
...
Â Â Â Â try {
Â Â Â Â Â Â final controller =
Â Â Â Â Â Â Â Â Â Â VideoPlayerController.networkUrl(Uri.parse(_mediaUrl));

Â Â Â Â Â Â await controller.initialize();
Â Â Â Â Â Â await controller.setLooping(false);
Â Â Â Â Â Â await controller.setVolume(_muted ? 0 : 1);

Â Â Â Â Â Â controller.addListener(_videoListener);

Â Â Â Â Â Â await controller.play();

Â Â Â Â Â Â if (!mounted) {
Â Â Â Â Â Â Â Â controller.removeListener(_videoListener);
Â Â Â Â Â Â Â Â await controller.dispose();
Â Â Â Â Â Â Â Â return;
Â Â Â Â Â Â }

Â Â Â Â Â Â setState(() {
Â Â Â Â Â Â Â Â _videoController = controller;
Â Â Â Â Â Â Â Â _videoReady = true;
Â Â Â Â Â Â });
Â Â Â Â } catch (error) {
Â Â Â Â Â Â if (!mounted) return;

Â Â Â Â Â Â setState(() {
Â Â Â Â Â Â Â Â _videoError = error.toString();
Â Â Â Â Â Â });
Â Â Â Â }
Â Â }

Â Â void _videoListener() {
Â Â Â Â final controller = _videoController;

Â Â Â Â if (!mounted ||
Â Â Â Â Â Â Â Â controller == null ||
Â Â Â Â Â Â Â Â !controller.value.isInitialized) {
Â Â Â Â Â Â return;
Â Â Â Â }

Â Â Â Â final duration = controller.value.duration.inMilliseconds;
Â Â Â Â final position = controller.value.position.inMilliseconds;

Â Â Â Â if (duration > 0) {
Â Â Â Â Â Â final nextProgress = (position / duration).clamp(0.0, 1.0);

Â Â Â Â Â Â if ((nextProgress - _progress).abs() > .01) {
Â Â Â Â Â Â Â Â setState(() {
Â Â Â Â Â Â Â Â Â Â _progress = nextProgress;
Â Â Â Â Â Â Â Â });
Â Â Â Â Â Â }
Â Â Â Â }

Â Â Â Â if (controller.value.isCompleted && !_advancing) {
Â Â Â Â Â Â _advancing = true;
Â Â Â Â Â Â _nextStory();
Â Â Â Â }
Â Â }

Â Â Future<void> _goToStory(int nextIndex) async {
Â Â Â Â if (nextIndex < 0) return;

Â Â Â Â if (nextIndex >= widget.stories.length) {
Â Â Â Â Â Â if (mounted) {
Â Â Â Â Â Â Â Â Navigator.of(context).pop();
Â Â Â Â Â Â }
Â Â Â Â Â Â return;
Â Â Â Â }

Â Â Â Â setState(() {
Â Â Â Â Â Â _index = nextIndex;
Â Â Â Â Â Â _progress = 0;
Â Â Â Â });

Â Â Â Â await _loadCurrentStory();
Â Â }

Â Â void _nextStory() {
Â Â Â Â _goToStory(_index + 1);
Â Â }

Â Â void _previousStory() {
Â Â Â Â if (_index > 0) {
Â Â Â Â Â Â _goToStory(_index - 1);
Â Â Â Â Â Â return;
Â Â Â Â }

Â Â Â Â final controller = _videoController;

Â Â Â Â if (controller != null) {
Â Â Â Â Â Â controller.seekTo(Duration.zero);
Â Â Â Â Â Â controller.play();

Â Â Â Â Â Â setState(() {
Â Â Â Â Â Â Â Â _progress = 0;
Â Â Â Â Â Â });
Â Â Â Â }
Â Â }

Â Â Future<void> _toggleMute() async {
Â Â Â Â setState(() {
Â Â Â Â Â Â _muted = !_muted;
Â Â Â Â });

Â Â Â Â await _videoController?.setVolume(_muted ? 0 : 1);
Â Â }

Â Â Future<void> _sendReply([String? reaction]) async {
Â Â Â Â if (_sendingReply || _isOwnStory) return;

Â Â Â Â final user = Supabase.instance.client.auth.currentUser;

Â Â Â Â if (user == null || _authorId.isEmpty) return;

Â Â Â Â final message = (reaction ?? _replyController.text).trim();

Â Â Â Â if (message.isEmpty) return;

Â Â Â Â setState(() {
Â Â Â Â Â Â _sendingReply = true;
Â Â Â Â });

Â Â Â Â try {
Â Â Â Â Â Â await Supabase.instance.client.from('messages').insert({
Â Â Â Â Â Â Â Â 'sender_id': user.id,
Â Â Â Â Â Â Â Â 'receiver_id': _authorId,
Â Â Â Â Â Â Â Â 'message': message,
Â Â Â Â Â Â });

Â Â Â Â Â Â _replyController.clear();

Â Â Â Â Â Â if (!mounted) return;

Â Â Â Â Â Â ScaffoldMessenger.of(context).showSnackBar(
Â Â Â Â Â Â Â Â const SnackBar(
Â Â Â Â Â Â Â Â Â Â content: Text('Story reply sent.'),
Â Â Â Â Â Â Â Â Â Â duration: Duration(seconds: 1),
Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â );
Â Â Â Â } catch (_) {
Â Â Â Â Â Â if (!mounted) return;
...
Â Â Â Â Â Â ScaffoldMessenger.of(context).showSnackBar(
Â Â Â Â Â Â Â Â const SnackBar(
Â Â Â Â Â Â Â Â Â Â content: Text('Unable to send Story reply.'),
Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â );
Â Â Â Â } finally {
Â Â Â Â Â Â if (mounted) {
Â Â Â Â Â Â Â Â setState(() {
Â Â Â Â Â Â Â Â Â Â _sendingReply = false;
Â Â Â Â Â Â Â Â });
Â Â Â Â Â Â }
Â Â Â Â }
Â Â }

Â Â Future<void> _showStoryMenu() async {
Â Â Â Â await showModalBottomSheet<void>(
Â Â Â Â Â Â context: context,
Â Â Â Â Â Â backgroundColor: const Color(0xFF10131D),
Â Â Â Â Â Â builder: (sheetContext) {
Â Â Â Â Â Â Â Â return SafeArea(
Â Â Â Â Â Â Â Â Â Â child: Column(
Â Â Â Â Â Â Â Â Â Â Â Â mainAxisSize: MainAxisSize.min,
Â Â Â Â Â Â Â Â Â Â Â Â children: [
Â Â Â Â Â Â Â Â Â Â Â Â Â Â if (_isOwnStory)
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â const ListTile(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â leading: Icon(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Icons.visibility_outlined,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â title: Text(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â 'Your Story',
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â style: TextStyle(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â fontWeight: FontWeight.w800,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â )
Â Â Â Â Â Â Â Â Â Â Â Â Â Â else
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ListTile(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â leading: const Icon(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Icons.flag_outlined,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â title: const Text(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â 'Report Story',
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â style: TextStyle(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â fontWeight: FontWeight.w800,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â onTap: () => Navigator.of(sheetContext).pop(),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â ListTile(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â leading: const Icon(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Icons.close_rounded,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â title: const Text(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â 'Close Story',
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â style: TextStyle(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â fontWeight: FontWeight.w800,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â onTap: () {
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Navigator.of(sheetContext).pop();
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Navigator.of(context).pop();
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â },
...
Â Â Widget _progressBars() {
Â Â Â Â return Row(
Â Â Â Â Â Â children: List.generate(widget.stories.length, (i) {
Â Â Â Â Â Â Â Â final double value;

Â Â Â Â Â Â Â Â if (i < _index) {
Â Â Â Â Â Â Â Â Â Â value = 1;
Â Â Â Â Â Â Â Â } else if (i == _index) {
Â Â Â Â Â Â Â Â Â Â value = _progress;
Â Â Â Â Â Â Â Â } else {
Â Â Â Â Â Â Â Â Â Â value = 0;
Â Â Â Â Â Â Â Â }

Â Â Â Â Â Â Â Â return Expanded(
Â Â Â Â Â Â Â Â Â Â child: Padding(
Â Â Â Â Â Â Â Â Â Â Â Â padding: EdgeInsets.only(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â right: i == widget.stories.length - 1 ? 0 : 4,
Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â child: ClipRRect(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â borderRadius: BorderRadius.circular(20),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: LinearProgressIndicator(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â value: value,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â minHeight: 3,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â backgroundColor: Colors.white.withValues(alpha: .30),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â valueColor:
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â const AlwaysStoppedAnimation<Color>(Colors.white),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â );
...
Â Â Widget _storyMedia() {
Â Â Â Â if (_mediaUrl.isEmpty) {
Â Â Â Â Â Â return const Center(
Â Â Â Â Â Â Â Â child: Icon(
Â Â Â Â Â Â Â Â Â Â Icons.broken_image_outlined,
Â Â Â Â Â Â Â Â Â Â color: Colors.white54,
Â Â Â Â Â Â Â Â Â Â size: 56,
Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â );
Â Â Â Â }

Â Â Â Â if (!_isVideo) {
Â Â Â Â Â Â return Image.network(
Â Â Â Â Â Â Â Â _mediaUrl,
Â Â Â Â Â Â Â Â width: double.infinity,
Â Â Â Â Â Â Â Â height: double.infinity,
Â Â Â Â Â Â Â Â fit: BoxFit.cover,
Â Â Â Â Â Â Â Â errorBuilder: (_, __, ___) => const Center(
Â Â Â Â Â Â Â Â Â Â child: Icon(
Â Â Â Â Â Â Â Â Â Â Â Â Icons.broken_image_outlined,
Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white54,
Â Â Â Â Â Â Â Â Â Â Â Â size: 56,
Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â );
Â Â Â Â }

Â Â Â Â if (_videoError != null) {
Â Â Â Â Â Â return const Center(
Â Â Â Â Â Â Â Â child: Text(
Â Â Â Â Â Â Â Â Â Â 'Unable to play Story video.',
Â Â Â Â Â Â Â Â Â Â style: TextStyle(
Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white70,
Â Â Â Â Â Â Â Â Â Â Â Â fontWeight: FontWeight.w800,
Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â );
Â Â Â Â }

Â Â Â Â if (!_videoReady || _videoController == null) {
Â Â Â Â Â Â return const Center(
Â Â Â Â Â Â Â Â child: CircularProgressIndicator(),
Â Â Â Â Â Â );
Â Â Â Â }

Â Â Â Â final controller = _videoController!;
Â Â Â Â final size = controller.value.size;

Â Â Â Â final width = size.width <= 0 ? 9.0 : size.width;
Â Â Â Â final height = size.height <= 0 ? 16.0 : size.height;

Â Â Â Â return ClipRect(
Â Â Â Â Â Â child: SizedBox.expand(
Â Â Â Â Â Â Â Â child: FittedBox(
Â Â Â Â Â Â Â Â Â Â fit: BoxFit.cover,
Â Â Â Â Â Â Â Â Â Â alignment: Alignment.center,
Â Â Â Â Â Â Â Â Â Â child: SizedBox(
Â Â Â Â Â Â Â Â Â Â Â Â width: width,
Â Â Â Â Â Â Â Â Â Â Â Â height: height,
Â Â Â Â Â Â Â Â Â Â Â Â child: VideoPlayer(controller),
Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â ),
Â Â Â Â );
...
Â Â Â Â if (controller != null) {
Â Â Â Â Â Â controller.removeListener(_videoListener);
Â Â Â Â Â Â controller.dispose();
Â Â Â Â }

Â Â Â Â _replyController.dispose();
...
Â Â Â Â final author =
Â Â Â Â Â Â Â Â _story['author_name']?.toString().trim() ?? '999 Member';

Â Â Â Â final photo =
Â Â Â Â Â Â Â Â _story['author_photo_url']?.toString().trim() ?? '';

Â Â Â Â final caption = _story['body']?.toString().trim() ?? '';

Â Â Â Â return Scaffold(
Â Â Â Â Â Â backgroundColor: Colors.black,
Â Â Â Â Â Â body: SafeArea(
Â Â Â Â Â Â Â Â child: Stack(
Â Â Â Â Â Â Â Â Â Â fit: StackFit.expand,
Â Â Â Â Â Â Â Â Â Â children: [
Â Â Â Â Â Â Â Â Â Â Â Â Positioned.fill(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: _storyMedia(),
Â Â Â Â Â Â Â Â Â Â Â Â ),

Â Â Â Â Â Â Â Â Â Â Â Â Positioned.fill(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: Row(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â children: [
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Expanded(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: GestureDetector(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â behavior: HitTestBehavior.translucent,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â onTap: _previousStory,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Expanded(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: GestureDetector(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â behavior: HitTestBehavior.translucent,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â onTap: _nextStory,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ],
Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
...
Â Â Â Â Â Â Â Â Â Â Â Â Positioned(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â left: 10,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â right: 10,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â top: 7,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: Column(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â children: [
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â _progressBars(),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â const SizedBox(height: 8),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Row(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â children: [
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â if (photo.isNotEmpty)
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â CircleAvatar(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â radius: 19,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â backgroundImage: NetworkImage(photo),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â )
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â else
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â const CircleAvatar(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â radius: 19,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: Icon(Icons.person_rounded),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â const SizedBox(width: 9),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Expanded(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: Text(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â author,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â maxLines: 1,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â overflow: TextOverflow.ellipsis,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â style: const TextStyle(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â fontSize: 14,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â fontWeight: FontWeight.w900,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â shadows: [
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Shadow(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.black87,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â blurRadius: 8,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ],
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â if (_isVideo)
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â IconButton(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â onPressed: _toggleMute,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â icon: Icon(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â _muted
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ? Icons.volume_off_rounded
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â : Icons.volume_up_rounded,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â IconButton(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â onPressed: _showStoryMenu,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â icon: const Icon(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Icons.more_horiz_rounded,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â IconButton(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â onPressed: () => Navigator.of(context).pop(),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â icon: const Icon(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Icons.close_rounded,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â size: 28,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ],
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
...
Â Â Â Â Â Â Â Â Â Â Â Â if (caption.isNotEmpty)
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Positioned(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â left: 18,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â right: 18,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â bottom: _isOwnStory ? 28 : 82,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: Center(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: Container(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â padding: const EdgeInsets.symmetric(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â horizontal: 16,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â vertical: 9,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â decoration: BoxDecoration(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.black.withValues(alpha: .58),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â borderRadius: BorderRadius.circular(22),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: Text(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â caption,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â textAlign: TextAlign.center,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â style: const TextStyle(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â fontSize: 14,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â fontWeight: FontWeight.w800,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
...
Â Â Â Â Â Â Â Â Â Â Â Â if (!_isOwnStory)
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Positioned(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â left: 9,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â right: 9,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â bottom: 10,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: Row(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â children: [
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Expanded(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: Container(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â height: 50,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â decoration: BoxDecoration(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.black.withValues(alpha: .58),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â borderRadius: BorderRadius.circular(28),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â border: Border.all(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white.withValues(alpha: .40),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: TextField(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â controller: _replyController,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â textInputAction: TextInputAction.send,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â onSubmitted: (_) => _sendReply(),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â style: const TextStyle(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â decoration: const InputDecoration(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â border: InputBorder.none,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â hintText: 'Send message...',
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â hintStyle: TextStyle(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â color: Colors.white70,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â contentPadding: EdgeInsets.symmetric(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â horizontal: 17,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â vertical: 14,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â const SizedBox(width: 7),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â GestureDetector(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â onTap: () => _sendReply('â¤ï¸'),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: const CircleAvatar(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â radius: 23,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â backgroundColor: Color(0xFFFF295E),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: Text(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â 'â¤ï¸',
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â style: TextStyle(fontSize: 20),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â ),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â const SizedBox(width: 6),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â GestureDetector(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â onTap: () => _sendReply('ðŸ‘'),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: const CircleAvatar(
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â radius: 23,
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â backgroundColor: Color(0xFF2586FF),
Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â Â child: Text(
