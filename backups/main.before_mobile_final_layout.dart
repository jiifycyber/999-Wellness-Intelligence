  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        ...
        // Dedicated massage background image.
        LayoutBuilder(
          builder: (context, constraints) {
            ...
            return Stack(
              ...
              children: [
                ...
                // Mobile uses the SAME wide image, but scales it to keep
                // both massage scenes visible across the upper section.
                Positioned(
                  top: 0,
                  left: -225,
                  right: -225,
                ...
                // Fade the massage scene into the dark login area.
                Positioned(
                  top: 230,
                  left: 0,
                  right: 0,
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          ...
                          colors: [
                            Colors.transparent,
                            const Color(0xFF09060F).withValues(alpha: 0.72),
        ...
        // Light overlay only — keeps the photograph visible.
        Container(
          decoration: BoxDecoration(
            gradient: LinearGradient(
              begin: Alignment.topCenter,
        ...
        // Slight center darkening so the real Flutter login card stays readable.
        Center(
          child: Container(
            width: 650,
            decoration: BoxDecoration(
              gradient: RadialGradient(
                radius: 0.85,
                colors: [
                  const Color(0xFF0B0710).withValues(alpha: 0.20),
                  Colors.transparent,
                ],
              ),
            ),
