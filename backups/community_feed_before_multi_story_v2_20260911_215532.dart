...
class _CommunityStoryViewer extends StatefulWidget {
  const _CommunityStoryViewer({required this.story});
...
class _CommunityStoryViewerState extends State<_CommunityStoryViewer> {
  ...
  bool get _isVideo => widget.story['media_type']?.toString() == 'video';

  String get _mediaUrl => widget.story['_media_url']?.toString().trim() ?? '';
  ...
  String get _storyAuthorId =>
      widget.story['author_id']?.toString().trim() ?? '';
  ...
  Widget build(BuildContext context) {
    final author =
        widget.story['author_name']?.toString().trim() ?? '999 Member';

    final photo = widget.story['author_photo_url']?.toString().trim() ?? '';

    final caption = widget.story['body']?.toString().trim() ?? '';
