...
class _CommunityFeedScreenState extends State<CommunityFeedScreen> {
  ...
  Future<void> _openStoryCreator() async {
    ...
    final caption = await showDialog<String>(
      ...
      builder: (dialogContext) => AlertDialog(
        ...
        actions: [
          ...
          FilledButton(
            onPressed: () =>
                Navigator.of(dialogContext).pop(captionController.text.trim()),
    ...
    try {
      ...
      final stamp = DateTime.now().microsecondsSinceEpoch;
      mediaPath = '${user.id}/stories/${stamp}_${_safeName(file.name)}';
  ...
  Future<void> _openReelCreator() async {
    ...
    final caption = await showDialog<String>(
      context: context,
      builder: (dialogContext) => AlertDialog(
        backgroundColor: const Color(0xFF110A23),
        title: const Text(
          'Create Reel',
          style: TextStyle(color: Colors.white, fontWeight: FontWeight.w900),
        ),
    ...
    try {
      ...
      final stamp = DateTime.now().microsecondsSinceEpoch;
      mediaPath = '${user.id}/reels/${stamp}_${_safeName(file.name)}';
