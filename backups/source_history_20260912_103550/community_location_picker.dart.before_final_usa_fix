...
class _CommunityLocationPickerState extends State<CommunityLocationPicker> {
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          gradient: const LinearGradient(
            colors: [Color(0xFF102E5A), Color(0xFF172458), Color(0xFF251755)],
          ),
          borderRadius: BorderRadius.circular(18),
          border: Border.all(
            color: const Color(0xFF44DEFF).withValues(alpha: .55),
          ),
        ),
        child: Row(
          children: [
            Container(
              ...
              decoration: const BoxDecoration(
                ...
                gradient: LinearGradient(
                  colors: [Color(0xFFFF4D78), Color(0xFFFF7D5F)],
                ),
              ),
              child: locating
                  ? const Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: TextStyle(color: Color(0xFFAAB8D6), fontSize: 11),
                  ),
                ],
              ),
            ),
            const Icon(Icons.chevron_right_rounded, color: Color(0xFF76EFFF)),
          ],
        ),
      ),
    );
  ...
  Widget _resultTile(Map<String, dynamic> place) {
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          ...
          borderRadius: BorderRadius.circular(16),
          border: Border.all(
            color: const Color(0xFF536EFF).withValues(alpha: .25),
          ),
        ),
        child: Row(
          children: [
            Container(
              ...
              height: 42,
              decoration: BoxDecoration(
                color: const Color(0xFF5B43FF).withValues(alpha: .20),
                shape: BoxShape.circle,
              ),
              child: const Icon(
  ...
  List<Map<String, dynamic>> _rankedLocationResults() {
    ...
    int score(Map<String, dynamic> place) {
      ...
      if (text.contains('united states')) points += 500;
      if (text.contains('kentucky')) points += 900;
      if (text.contains('louisville')) points += 1500;

      if (query.isNotEmpty) {
        if (text.startsWith(query)) points += 400;
        if (text.contains(query)) points += 250;

        if ('louisville'.startsWith(query)) {
          if (text.contains('louisville')) points += 2500;
          if (text.contains('kentucky')) points += 1500;
        }
      }
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Add Location', style: TextStyle(fontWeight: FontWeight.w900)),
            Text(
              '999 WELLNESS',
              style: TextStyle(
          ...
          children: [
            Padding(
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: const TextStyle(color: Color(0xFF7D8BAA)),
                  ...
                  filled: true,
                  fillColor: const Color(0xFF0B1830),
                  ...
                  enabledBorder: OutlineInputBorder(
                    ...
                    borderSide: BorderSide(
                      color: const Color(0xFF4B6CFF).withValues(alpha: .25),
                    ),
                  ),
                  focusedBorder: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(18),
                    borderSide: const BorderSide(color: Color(0xFF35E5FF)),
                  ),
                ),
              ),
            ),
            ...
            if (searching)
              const Padding(
                ...
                child: CircularProgressIndicator(color: Color(0xFF54E9FF)),
              ),
            if (!searching)
              Expanded(
                child: results.isEmpty
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          return _resultTile(rankedResults[index]);
                        },
                      ),
              ),
          ],
