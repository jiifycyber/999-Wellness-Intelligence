    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [
            const Color(0xFF0C1830).withValues(alpha: .96),
            const Color(0xFF071020).withValues(alpha: .98),
          ],
        ),
        borderRadius: BorderRadius.circular(19),
        border: Border.all(
          color: const Color(0xFF35588E).withValues(alpha: .42),
          width: .8,
        ),
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF071329).withValues(alpha: .55),
            blurRadius: 28,
      ...
      child: Column(
        children: [
          Row(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              _avatar(currentPhoto, currentName, size: 52),
              const SizedBox(width: 13),
              Expanded(
                child: Container(
                  constraints: const BoxConstraints(minHeight: 61),
                  decoration: BoxDecoration(
                    color: const Color(0xFF10203E),
                    borderRadius: BorderRadius.circular(15),
                    border: Border.all(
                      color: const Color(0xFF5577B6).withValues(alpha: .88),
                    ),
                  ),
                  child: TextField(
  ...
  Widget _composerButton({
    ...
    return InkWell(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(12),
          border: Border.all(color: const Color(0xFF3D5E95)),
          color: const Color(0xFF09162C),
        ),
        child: Row(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
  ...
  Widget _buildTabs() {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        borderRadius: BorderRadius.circular(15),
        border: Border.all(color: const Color(0xFF31507E)),
      ),
      child: Row(
        children: [
          Expanded(
        ...
        decoration: BoxDecoration(
          gradient: selected
              ? const LinearGradient(
                  colors: [Color(0xFF6C35FF), Color(0xFF4732E7)],
                )
              : null,
          borderRadius: BorderRadius.circular(11),
          boxShadow: selected
              ? [
                  BoxShadow(
                    color: purple.withValues(alpha: .23),
                    blurRadius: 12,
                  ),
                ]
              : null,
    ...
    return Padding(
      ...
      child: _glassPanel(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding: const EdgeInsets.fromLTRB(16, 13, 13, 4),
              child: Row(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  _avatar(
                        ...
                        Wrap(
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: role == 'provider'
                                    ? const Color(0xFF143F52)
                                    : const Color(0xFF12315D),
                                borderRadius: BorderRadius.circular(20),
                                border: Border.all(
                                  color: role == 'provider'
                                      ? const Color(0xFF27B9D7)
                                            .withValues(alpha: .7)
                                      : const Color(0xFF367BE7)
                                            .withValues(alpha: .6),
                                ),
                              ),
                              child: Text(
            ...
            if (body.isNotEmpty)
              Padding(
                padding: const EdgeInsets.fromLTRB(70, 3, 18, 8),
                child: Text(
                  body,
                  style: const TextStyle(
            ...
            if (media.isNotEmpty)
              Padding(
                padding: const EdgeInsets.fromLTRB(16, 5, 16, 11),
                child: ClipRRect(
            ...
            Padding(
              padding: const EdgeInsets.fromLTRB(61, 0, 12, 7),
              child: Row(
                children: [
                  InkWell(
                    onTap: () {
