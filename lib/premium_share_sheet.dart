...
Future<void> showPremiumWellnessShareSheet(
  ...
  final base = Uri.parse(
    'https://yqnwdaoraubsbdxmouum.supabase.co/functions/v1/share-post',
  );
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          ...
          content: Row(
            children: [
              const Icon(Icons.check_circle_rounded, color: Color(0xFF59E6A7)),
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          behavior: SnackBarBehavior.floating,
          content: Text('Could not copy link. Use More to share instead.'),
        ),
      );
    }
  }
